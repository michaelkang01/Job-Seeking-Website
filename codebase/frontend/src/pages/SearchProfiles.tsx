  ...
  return (
    <div className="px-8  h-screen bg-gray-100">
      ...
      <main className="p-8 top-0">
        {authToken && authData ? (
          <>
            <div className="flex items-center bg-tiffany-blue text-white text-sm font-bold px-4 py-3 rounded-sm">
          ...
          <div className="flex items-center bg-tiffany-blue text-white text-sm font-bold px-4 py-3 rounded-sm" role="alert">
