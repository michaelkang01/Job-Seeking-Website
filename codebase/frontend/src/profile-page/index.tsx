    ...
    <div className="w-11/12 m-auto">
      <div className="float-left w-1/4 p-4">
        ...
        <div className="relative rounded-3xl mb-16 grid justify-items-center shadow-xl">
          <div className="flex relative rounded-t-3xl bg-green-600 w-full h-20 justify-center items-center">
            <p className="text-white font-semibold text-2xl">Elevator Pitch Video</p>
          </div>
          <ModalVideo
            channel="youtube"
            autoplay
      ...
      <div className="float-left w-3/4 p-4">
        <div className="relative rounded-3xl m-4 grid justify-items-center">
          <div className="rounded-t-3xl bg-green-600 w-full h-20"></div>
          <p className="z-100">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint
            dolorum iure blanditiis officia vero ipsa magnam ipsum sit quidem
            veritatis, quam quaerat laboriosam corporis harum recusandae odio
            error reprehenderit autem?
          </p>
        </div>
